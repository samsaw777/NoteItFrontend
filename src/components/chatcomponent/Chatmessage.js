          ...
          <div
            ...
            className={
              message.postedBy === user._id
                ? `w-1/2 bg-newsidebarcolor text-buttonColor p-2 mb-6 rounded-xl relative ml-auto mr-1 border-t-8 border-${message.tag}-400`
                : `w-1/2 bg-newsidebarcolor text-buttonColor p-2 mb-6 rounded-xl relative ml-1   border-${message.tag}-400 border-t-8`
            }
            key={message.id}
          >
            <div
