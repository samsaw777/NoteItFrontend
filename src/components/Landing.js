...
function Landing() {
  ...
  return (
    <div className="h-viewHeight bg-sidebarBackgroundColor ">
      ...
      <div className="text-center pt-10 lg:pt-16 w-full lg:px-64">
        <p className=" text-sm sm:text-sm md:text-sm lg:text-4xl text-gray-400">
          Track your daily,weekly and monthly work with - RFWT(Remote first work
          tracker)
        </p>
        <p className="text-sm text-gray-300 pt-16 lg:px-24 px-5">
